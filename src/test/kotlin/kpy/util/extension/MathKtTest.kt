...
class MathKtTest {
    ...
    @Test
    fun toDegrees() {
        assertThat(0.5.toDegrees().round(2)).isEqualTo(28.65F)
        assertThat(1.toDegrees().round(2)).isEqualTo(57.30F)
        assertThat(2.toDegrees().round(2)).isEqualTo(114.59F)
    }

    @Test
    fun toRadians() {
        assertThat(45.toRadians().round(2)).isEqualTo(0.79F)
        assertThat(90.toRadians().round(2)).isEqualTo(1.57F)
        assertThat(180.toRadians().round(2)).isEqualTo(3.14F)
    }
